...
export class BoundCallbackObservable<T> extends Observable<T> {
   ...
   * @owner Observable
   */
  static create = (<R>(func: Function,
                   selector: Function | void = undefined,
                   scheduler?: IScheduler) => {
    return function(this: any, ...args: any[]): Observable<R> {
      return new BoundCallbackObservable<R>(func, <any>selector, args, this, scheduler);
    };
  }) as any as typeof CreateFn;
